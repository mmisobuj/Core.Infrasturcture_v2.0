...
namespace Core.Infrastructure.Utilty
{
    public class Ean13
    {
        ...
        public string _sChecksumDigit;
        private string _sChecksumDigit_za;
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt) //edit by zakir
        {
            ...
            System.Drawing.Font font = new System.Drawing.Font("Arial", _fFontSize * Scale);

            // Calculate the Check Digit.
            CalculateChecksumDigit();

            sbTemp.AppendFormat("{0}{1}{2}{3}", //edit by zakir
                CountryCode,
                ManufacturerCode,
                ProductCode,
              ChecksumDigit
                //_sChecksumDigit_za //edit by zakir
                );
            ...
            for (int i = 0; i < strbEAN13.Length; i++)
            {
                if (sTempUPC.Substring(i, 1) == "1")
                {
                    ...
                    if (i > 12 && i < 55 || i > 57 && i < 101)
                        ...
                        g.FillRectangle(brush, xPosition, yStart, lineWidth, height - fTextHeight - za);
                    else
                        // Draw a full line.
                        g.FillRectangle(brush, xPosition, yStart, lineWidth, height - za);
                }
            ...
            float yPosition = yStart + (height - fTextHeight - za);
        ...
        public System.Drawing.Bitmap CreateBitmap()//edit by zakir
        {
            float tempWidth = Width * Scale * 3.6F;
            float tempHeight = Height * Scale * 2;

            System.Drawing.Bitmap bmp = new System.Drawing.Bitmap((int)tempWidth, (int)tempHeight);
            //System.Drawing.Imaging.ImageFormat b = 
            //bmp.
        ...
        public void CalculateChecksumDigit()
        {
            try
            {
                ...
                ChecksumDigit = iCheckSum.ToString();
                _sChecksumDigit_za = iCheckSum.ToString();
            }
            catch (Exception)
            {
                throw;
        ...
        public void CalculateChecksumDigitAddi(string CountryCode, string ManufacturerCode, string ProductCode) //Added by Mahfuj
        {
        ...
        public float Scale
        {
            ...
            set
            {
                if (value < _fMinimumAllowableScale || value > _fMaximumAllowableScale)
                    throw new Exception("Scale value out of allowable range.  Value must be between " +
                        _fMinimumAllowableScale.ToString() + " and " +
                        _fMaximumAllowableScale.ToString());
                _fScale = value;
            }
        }
        ...
        public string ChecksumDigit_sa
        {
            get
            {
                return _sChecksumDigit_za;
            }

            set
            {
                _sChecksumDigit_za = value;
            }
        }
