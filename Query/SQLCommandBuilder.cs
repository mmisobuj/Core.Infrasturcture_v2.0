...
namespace Core.Infrastructure.Query
{
    public static class SQLCommandBuilder  
    {
        ...
        public static string GetInsertCommand<T>(T obj)
        {
        ...
        public static string GetInsertCommand<T>(T obj, string columns)
        {
            StringBuilder sbValues = new StringBuilder();
            StringBuilder sbColumns = new StringBuilder();
            string[] arrColumns;
        ...
        public static string GetUpdateCommand<T>(T obj, string columns, string condition)
        {
            StringBuilder sbValues = new StringBuilder();
